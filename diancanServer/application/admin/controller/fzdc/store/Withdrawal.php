...
class Withdrawal extends Base
{
    ...
    /**
     * Withdrawal模型对象
     * @var \app\admin\model\fzdc\store\Withdrawal
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\fzdc\store\Withdrawal;
    ...
    public function edit($ids = null)
    {
        ...
        if ($params['status']==3){
            //扣除店铺余额
            \app\admin\model\fzdc\store\Store::where('id',$row['store_id'])->setDec('balance',$row['amount']);
        }
        $result = false;
        Db::startTrans();
        try {

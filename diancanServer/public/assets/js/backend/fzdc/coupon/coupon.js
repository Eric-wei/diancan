define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'fzdc/coupon/coupon/index' + location.search,
                    add_url: 'fzdc/coupon/coupon/add',
                    edit_url: 'fzdc/coupon/coupon/edit',
                    del_url: 'fzdc/coupon/coupon/del',
                    multi_url: 'fzdc/coupon/coupon/multi',
                    import_url: 'fzdc/coupon/coupon/import',
                    table: 'fzdc_coupon',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'draw_range', title: __('Draw_range'), operate: 'LIKE'},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'fzdc/coupon/coupon/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'fzdc/coupon/coupon/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'fzdc/coupon/coupon/destroy',
                                    refresh: true
                                }
                            ],

	...
	<view class="box">
		<u-sticky bgColor='#fafafa'>
			<view class="content_time">
				<view class="content_time_left" @tap="open">
		...
		<view class="content">
			<view class="main_content">
				...
				<emptyPage v-if="list.length<1"></emptyPage>

			</view>
		</view>
		<uni-calendar ref="calendar" :insert="false" @confirm="onConfirm" />
	</view>
</template>

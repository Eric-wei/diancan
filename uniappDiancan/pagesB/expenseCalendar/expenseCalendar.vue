	...
	<view class="box" v-if='display'>
		<view class="box_content">
			<view style="margin-top: 250rpx;" v-if="content_list.length<1">
				<u-empty mode="data" icon="/static/dc-empty.png" :iconSize='150' :textSize='24' text='暂无消费记录'></u-empty>
			</view>

			<view class="record_content flexc flexs" v-for="(item,index) in content_list" :key="item">
				<view class="record_content_left">
					<view style="font-size: 28rpx;" v-if="item.type==2">微信支付</view>
					<view style="font-size: 28rpx;" v-if="item.type==1">钱包支付</view>
